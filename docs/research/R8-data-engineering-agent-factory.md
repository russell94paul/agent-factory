...
**Status: DISPATCHED 2026-08-23.** Written 2026-08-22. Paste the whole file **and attach
...
| 2 | 2026-08-23 | **Dispatched with `R8-evidence-pack.md` attached** (500 KB, 23 sources, regenerated by `scripts/build_r8_pack.py`). |
